...
view model =
    let
        refreshClassList =
            case model of
                Loading ->
                    "text-white-50 me-1 bi bi-arrow-repeat rotate"

                _ ->
                    "text-white-50 me-1 bi bi-arrow-repeat"

        refresh =
            svg [ Svg.Attributes.class refreshClassList, width 16, height 16, viewBox "0 0 16 16", fill "currentColor" ]
